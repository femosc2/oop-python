...
class ForceWieldingDuelist():
    ...
    def __init__(self, name, force_name, rank, lightsaber_color, hilt_type):
        ...
        self.combatant_strenght = ForcePower.return_force_strenght(self.forcePower) + Rank.return_rank_strenght(self.rank) # Takes the force_strenght and rank_strenght and combines them into a value
    def __str__(self):
